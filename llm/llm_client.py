...
For flexible/open return tickets, set journey_type to "return" and return_date to "open".
...
- If the user says open return, flexible return, no return date, or they are not sure when they are coming back, use return_date = "open".
